	...
	function (from, to, pieces) {
		...
		if (_v0.$ === 'Nothing') {
			...
			return (!_Utils_eq(from, to)) && ((!targetIsFriendly) && function () {
				...
				switch (_v3.$) {
					case 'General':
						return (($elm$core$Basics$abs(dx) + $elm$core$Basics$abs(dy)) === 1) && A2($author$project$Xiangqi$inPalace, piece.side, to);
					case 'Advisor':
...
var $author$project$Test$Generated$Main28074385$main = A2(
	...
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'XiangqiTest',
				_List_fromArray(
					[$author$project$XiangqiTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main28074385':{'init':$author$project$Test$Generated$Main28074385$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-84079.sock";
