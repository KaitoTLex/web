...
var $author$project$Xiangqi$Black = {$: 'Black'};
var $author$project$Xiangqi$Chariot = {$: 'Chariot'};
var $author$project$Xiangqi$General = {$: 'General'};
var $author$project$Xiangqi$Piece = F2(
	function (side, kind) {
		return {kind: kind, side: side};
	});
var $author$project$Xiangqi$Red = {$: 'Red'};
var $author$project$Xiangqi$Soldier = {$: 'Soldier'};
...
var $author$project$Xiangqi$boardPositions = A2(
	$elm$core$List$concatMap,
	function (rank) {
		return A2(
			$elm$core$List$map,
			function (file) {
				return _Utils_Tuple2(file, rank);
			},
...
var $author$project$Xiangqi$pieceAt = F2(
		...
		return A2(
			...
			$elm$core$List$head(
				A2(
					...
					function (_v0) {
						var candidate = _v0.a;
						return _Utils_eq(candidate, position);
					},
					pieces)));
	});
var $author$project$Xiangqi$applyMove = F3(
	function (from, to, pieces) {
		var _v0 = A2($author$project$Xiangqi$pieceAt, from, pieces);
		if (_v0.$ === 'Nothing') {
			return pieces;
		} else {
			var piece = _v0.a;
			return A2(
				$elm$core$List$cons,
				_Utils_Tuple2(to, piece),
				A2(
					$elm$core$List$filter,
					function (_v1) {
						var position = _v1.a;
						return (!_Utils_eq(position, from)) && (!_Utils_eq(position, to));
					},
					pieces));
		}
	});
var $author$project$Xiangqi$findGeneral = F2(
	function (side, pieces) {
		return A2(
			$elm$core$Maybe$map,
			...
			$elm$core$List$head(
				A2(
					...
					function (_v0) {
						var piece = _v0.b;
						return _Utils_eq(piece.side, side) && _Utils_eq(piece.kind, $author$project$Xiangqi$General);
					},
					pieces)));
	});
var $author$project$Xiangqi$Advisor = {$: 'Advisor'};
var $author$project$Xiangqi$diagDirs = _List_fromArray(
	[
		_Utils_Tuple2(1, 1),
		_Utils_Tuple2(1, -1),
		_Utils_Tuple2(-1, 1),
...
var $author$project$Xiangqi$inBoard = function (_v0) {
	var file = _v0.a;
	var rank = _v0.b;
	return (file >= 0) && ((file <= 8) && ((rank >= 0) && (rank <= 9)));
};
var $author$project$Xiangqi$inPalace = F2(
	function (side, _v0) {
		var file = _v0.a;
		var rank = _v0.b;
		return (file >= 3) && ((file <= 5) && (_Utils_eq(side, $author$project$Xiangqi$Red) ? ((rank >= 7) && (rank <= 9)) : ((rank >= 0) && (rank <= 2))));
	});
var $author$project$Xiangqi$step = F3(
	function (_v0, df, dr) {
		var file = _v0.a;
		var rank = _v0.b;
		return _Utils_Tuple2(file + df, rank + dr);
	});
var $author$project$Xiangqi$advisorAttacks = F3(
	function (target, by, pieces) {
		return A2(
			$elm$core$List$any,
			function (_v0) {
				var df = _v0.a;
				var dr = _v0.b;
				var src = A3($author$project$Xiangqi$step, target, -df, -dr);
				return $author$project$Xiangqi$inBoard(src) && (A2($author$project$Xiangqi$inPalace, by, target) && A2(
					$elm$core$Maybe$withDefault,
					false,
					A2(
						$elm$core$Maybe$map,
						function (p) {
							return _Utils_eq(p.side, by) && _Utils_eq(p.kind, $author$project$Xiangqi$Advisor);
						},
						A2($author$project$Xiangqi$pieceAt, src, pieces))));
			},
			$author$project$Xiangqi$diagDirs);
	});
var $author$project$Xiangqi$Elephant = {$: 'Elephant'};
var $author$project$Xiangqi$isEmpty = F2(
	function (position, pieces) {
		return _Utils_eq(
			A2($author$project$Xiangqi$pieceAt, position, pieces),
			$elm$core$Maybe$Nothing);
	});
var $author$project$Xiangqi$onOwnSide = F2(
	function (side, rank) {
		return _Utils_eq(side, $author$project$Xiangqi$Red) ? (rank >= 5) : (rank <= 4);
	});
var $author$project$Xiangqi$bishopAttacks = F3(
	function (_v0, by, pieces) {
		var f0 = _v0.a;
		var r0 = _v0.b;
		return A2(
			$elm$core$List$any,
			function (_v1) {
				var df = _v1.a;
				var dr = _v1.b;
				var src = _Utils_Tuple2(f0 - (2 * df), r0 - (2 * dr));
				var mid = _Utils_Tuple2(f0 - df, r0 - dr);
				return $author$project$Xiangqi$inBoard(src) && (A2($author$project$Xiangqi$onOwnSide, by, r0) && (A2($author$project$Xiangqi$isEmpty, mid, pieces) && A2(
					$elm$core$Maybe$withDefault,
					false,
					A2(
						$elm$core$Maybe$map,
						function (p) {
							return _Utils_eq(p.side, by) && _Utils_eq(p.kind, $author$project$Xiangqi$Elephant);
						},
						A2($author$project$Xiangqi$pieceAt, src, pieces)))));
			},
			$author$project$Xiangqi$diagDirs);
...
var $author$project$Xiangqi$flyingGeneralAttack = F3(
	function (_v0, by, pieces) {
		var f0 = _v0.a;
		var r0 = _v0.b;
		var _v1 = A2($author$project$Xiangqi$findGeneral, by, pieces);
		if (_v1.$ === 'Nothing') {
			return false;
		} else {
			var _v2 = _v1.a;
			var gf = _v2.a;
			var gr = _v2.b;
			return ((!_Utils_eq(gf, f0)) || _Utils_eq(
				_Utils_Tuple2(gf, gr),
				_Utils_Tuple2(f0, r0))) ? false : A2(
				$elm$core$List$all,
				function (r) {
					return A2(
						$author$project$Xiangqi$isEmpty,
						_Utils_Tuple2(f0, r),
						pieces);
				},
				A2(
					$elm$core$List$range,
					A2($elm$core$Basics$min, gr, r0) + 1,
					A2($elm$core$Basics$max, gr, r0) - 1));
		}
	});
var $author$project$Xiangqi$Horse = {$: 'Horse'};
var $author$project$Xiangqi$knightOffsets = _List_fromArray(
	[
		_Utils_Tuple2(1, 2),
		_Utils_Tuple2(1, -2),
		_Utils_Tuple2(-1, 2),
...
var $author$project$Xiangqi$legSquare = F3(
	function (_v0, df, dr) {
		var file = _v0.a;
		var rank = _v0.b;
		return ($elm$core$Basics$abs(df) === 2) ? _Utils_Tuple2(file + ((df / 2) | 0), rank) : _Utils_Tuple2(file, rank + ((dr / 2) | 0));
	});
var $author$project$Xiangqi$knightAttacks = F3(
	function (target, by, pieces) {
		return A2(
			$elm$core$List$any,
			function (_v0) {
				...
				var dr = _v0.b;
				var src = A3($author$project$Xiangqi$step, target, -df, -dr);
				return $author$project$Xiangqi$inBoard(src) && (A2(
					$author$project$Xiangqi$isEmpty,
					A3($author$project$Xiangqi$legSquare, src, df, dr),
					pieces) && A2(
					$elm$core$Maybe$withDefault,
					false,
					A2(
						$elm$core$Maybe$map,
						function (p) {
							return _Utils_eq(p.side, by) && _Utils_eq(p.kind, $author$project$Xiangqi$Horse);
						},
						A2($author$project$Xiangqi$pieceAt, src, pieces))));
			},
			$author$project$Xiangqi$knightOffsets);
	});
var $author$project$Xiangqi$orthoDirs = _List_fromArray(
	[
		_Utils_Tuple2(0, 1),
		_Utils_Tuple2(0, -1),
		_Utils_Tuple2(1, 0),
...
var $author$project$Xiangqi$Cannon = {$: 'Cannon'};
var $author$project$Xiangqi$rayAttackPastScreen = F5(
	function (pos, by, pieces, df, dr) {
		rayAttackPastScreen:
		while (true) {
			if (!$author$project$Xiangqi$inBoard(pos)) {
				return false;
			} else {
				var _v0 = A2($author$project$Xiangqi$pieceAt, pos, pieces);
				if (_v0.$ === 'Nothing') {
					var $temp$pos = A3($author$project$Xiangqi$step, pos, df, dr),
						$temp$by = by,
						$temp$pieces = pieces,
						$temp$df = df,
						$temp$dr = dr;
					...
					df = $temp$df;
					dr = $temp$dr;
					continue rayAttackPastScreen;
				} else {
					var piece = _v0.a;
					return _Utils_eq(piece.side, by) && _Utils_eq(piece.kind, $author$project$Xiangqi$Cannon);
				}
			}
		}
	});
var $author$project$Xiangqi$rayAttack = F6(
	function (target, pos, by, pieces, df, dr) {
		rayAttack:
		while (true) {
			if (!$author$project$Xiangqi$inBoard(pos)) {
				return false;
				...
				if (_v0.$ === 'Nothing') {
					var $temp$target = target,
						$temp$pos = A3($author$project$Xiangqi$step, pos, df, dr),
						$temp$by = by,
						$temp$pieces = pieces,
						$temp$df = df,
						$temp$dr = dr;
					...
					var piece = _v0.a;
					return (_Utils_eq(piece.side, by) && _Utils_eq(piece.kind, $author$project$Xiangqi$Chariot)) ? true : ((_Utils_eq(piece.side, by) && (_Utils_eq(piece.kind, $author$project$Xiangqi$General) && (_Utils_eq(
						pos,
						A3($author$project$Xiangqi$step, target, df, dr)) && A2($author$project$Xiangqi$inPalace, by, target)))) ? true : A5(
						$author$project$Xiangqi$rayAttackPastScreen,
						A3($author$project$Xiangqi$step, pos, df, dr),
						by,
						pieces,
						df,
						dr));
...
var $author$project$Xiangqi$orthogonalAttacks = F3(
	function (target, by, pieces) {
		return A2(
			$elm$core$List$any,
			function (_v0) {
				...
				var dr = _v0.b;
				return A6(
					$author$project$Xiangqi$rayAttack,
					target,
					A3($author$project$Xiangqi$step, target, df, dr),
					by,
					pieces,
					df,
					dr);
			},
			$author$project$Xiangqi$orthoDirs);
	});
var $author$project$Xiangqi$pawnAttacks = F3(
	function (_v0, by, pieces) {
		var f0 = _v0.a;
		var r0 = _v0.b;
		var isSoldierOf = function (src) {
			return A2(
				$elm$core$Maybe$withDefault,
				false,
				A2(
					$elm$core$Maybe$map,
					function (p) {
						return _Utils_eq(p.side, by) && _Utils_eq(p.kind, $author$project$Xiangqi$Soldier);
					},
					A2($author$project$Xiangqi$pieceAt, src, pieces)));
		};
		var sideHit = A2(
			$elm$core$List$any,
			function (df) {
				var src = _Utils_Tuple2(f0 + df, r0);
				return $author$project$Xiangqi$inBoard(src) && ((!A2($author$project$Xiangqi$onOwnSide, by, r0)) && isSoldierOf(src));
			},
			_List_fromArray(
				[-1, 1]));
		var forward = _Utils_eq(by, $author$project$Xiangqi$Red) ? (-1) : 1;
		var forwardSrc = _Utils_Tuple2(f0, r0 - forward);
		var forwardHit = $author$project$Xiangqi$inBoard(forwardSrc) && isSoldierOf(forwardSrc);
		return forwardHit || sideHit;
	});
var $author$project$Xiangqi$isSquareAttacked = F3(
	function (target, by, pieces) {
		return A3($author$project$Xiangqi$orthogonalAttacks, target, by, pieces) || (A3($author$project$Xiangqi$knightAttacks, target, by, pieces) || (A3($author$project$Xiangqi$bishopAttacks, target, by, pieces) || (A3($author$project$Xiangqi$advisorAttacks, target, by, pieces) || (A3($author$project$Xiangqi$pawnAttacks, target, by, pieces) || A3($author$project$Xiangqi$flyingGeneralAttack, target, by, pieces)))));
	});
var $author$project$Xiangqi$opposite = function (side) {
	return _Utils_eq(side, $author$project$Xiangqi$Red) ? $author$project$Xiangqi$Black : $author$project$Xiangqi$Red;
};
var $author$project$Xiangqi$inCheck = F2(
	function (side, pieces) {
		var _v0 = A2($author$project$Xiangqi$findGeneral, side, pieces);
		if (_v0.$ === 'Nothing') {
			return false;
		} else {
			var generalPos = _v0.a;
			return A3(
				$author$project$Xiangqi$isSquareAttacked,
				generalPos,
				$author$project$Xiangqi$opposite(side),
				pieces);
		}
	});
var $author$project$Xiangqi$leavesInCheck = F4(
	function (side, from, to, pieces) {
		return A2(
			$author$project$Xiangqi$inCheck,
			side,
			A3($author$project$Xiangqi$applyMove, from, to, pieces));
	});
var $author$project$Xiangqi$piecesBetween = F3(
	function (_v0, _v1, pieces) {
		var fromFile = _v0.a;
		var fromRank = _v0.b;
		var toFile = _v1.a;
		var toRank = _v1.b;
		var liesBetween = function (_v3) {
			var file = _v3.a;
			var rank = _v3.b;
			return _Utils_eq(fromFile, toFile) ? (_Utils_eq(file, fromFile) && ((_Utils_cmp(
				rank,
				A2($elm$core$Basics$min, fromRank, toRank)) > 0) && (_Utils_cmp(
				rank,
				A2($elm$core$Basics$max, fromRank, toRank)) < 0))) : (_Utils_eq(rank, fromRank) && ((_Utils_cmp(
				file,
				A2($elm$core$Basics$min, fromFile, toFile)) > 0) && (_Utils_cmp(
				file,
				A2($elm$core$Basics$max, fromFile, toFile)) < 0)));
		};
		return $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (_v2) {
					var position = _v2.a;
					return liesBetween(position);
				},
				pieces));
	});
var $author$project$Xiangqi$soldierMove = F4(
	function (side, fromRank, dx, dy) {
		var forward = _Utils_eq(side, $author$project$Xiangqi$Red) ? (-1) : 1;
		var crossedRiver = _Utils_eq(side, $author$project$Xiangqi$Red) ? (fromRank <= 4) : (fromRank >= 5);
		return ((!dx) && _Utils_eq(dy, forward)) || (crossedRiver && (($elm$core$Basics$abs(dx) === 1) && (!dy)));
	});
var $author$project$Xiangqi$pseudoLegalMove = F3(
	function (from, to, pieces) {
		var _v0 = A2($author$project$Xiangqi$pieceAt, from, pieces);
		if (_v0.$ === 'Nothing') {
			return false;
			...
			var piece = _v0.a;
			var targetIsFriendly = A2(
				$elm$core$Maybe$withDefault,
				false,
				A2(
					$elm$core$Maybe$map,
					function (target) {
						return _Utils_eq(target.side, piece.side);
					},
					A2($author$project$Xiangqi$pieceAt, to, pieces)));
			var _v1 = to;
			var toFile = _v1.a;
			var toRank = _v1.b;
			var _v2 = from;
			...
			return (!_Utils_eq(from, to)) && ((!targetIsFriendly) && function () {
				var _v3 = piece.kind;
				switch (_v3.$) {
					case 'General':
						return ((($elm$core$Basics$abs(dx) + $elm$core$Basics$abs(dy)) === 1) && A2($author$project$Xiangqi$inPalace, piece.side, to)) || ((!dx) && ((!A3($author$project$Xiangqi$piecesBetween, from, to, pieces)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$map,
								function (target) {
									return (!_Utils_eq(target.side, piece.side)) && _Utils_eq(target.kind, $author$project$Xiangqi$General);
								},
								A2($author$project$Xiangqi$pieceAt, to, pieces)))));
					case 'Advisor':
						return ($elm$core$Basics$abs(dx) === 1) && (($elm$core$Basics$abs(dy) === 1) && A2($author$project$Xiangqi$inPalace, piece.side, to));
					case 'Elephant':
						return ($elm$core$Basics$abs(dx) === 2) && (($elm$core$Basics$abs(dy) === 2) && (A2($author$project$Xiangqi$onOwnSide, piece.side, toRank) && A2(
							$author$project$Xiangqi$isEmpty,
							_Utils_Tuple2(fromFile + ((dx / 2) | 0), fromRank + ((dy / 2) | 0)),
							pieces)));
					case 'Horse':
						return (($elm$core$Basics$abs(dx) === 2) && ($elm$core$Basics$abs(dy) === 1)) ? A2(
							$author$project$Xiangqi$isEmpty,
							_Utils_Tuple2(fromFile + ((dx / 2) | 0), fromRank),
							pieces) : ((($elm$core$Basics$abs(dx) === 1) && ($elm$core$Basics$abs(dy) === 2)) ? A2(
							$author$project$Xiangqi$isEmpty,
							_Utils_Tuple2(fromFile, fromRank + ((dy / 2) | 0)),
							pieces) : false);
					case 'Chariot':
						return ((!dx) || (!dy)) && (!A3($author$project$Xiangqi$piecesBetween, from, to, pieces));
					case 'Cannon':
						if ((!(!dx)) && (!(!dy))) {
							return false;
						} else {
							var _v4 = A2($author$project$Xiangqi$pieceAt, to, pieces);
							if (_v4.$ === 'Nothing') {
								return !A3($author$project$Xiangqi$piecesBetween, from, to, pieces);
							} else {
								return A3($author$project$Xiangqi$piecesBetween, from, to, pieces) === 1;
							}
						}
					default:
						return A4($author$project$Xiangqi$soldierMove, piece.side, fromRank, dx, dy);
				}
			}());
		}
	});
var $author$project$Xiangqi$isLegalMove = F4(
	function (side, from, to, pieces) {
		return A3($author$project$Xiangqi$pseudoLegalMove, from, to, pieces) && (!A4($author$project$Xiangqi$leavesInCheck, side, from, to, pieces));
	});
var $author$project$Xiangqi$generateLegalMoves = F2(
	function (side, pieces) {
		return A2(
			$elm$core$List$concatMap,
			function (_v1) {
				...
				return A2(
					...
					A2(
						$elm$core$List$filter,
						function (to) {
							return A4($author$project$Xiangqi$isLegalMove, side, from, to, pieces);
						},
						$author$project$Xiangqi$boardPositions));
			},
			A2(
				$elm$core$List$filter,
				function (_v0) {
					var piece = _v0.b;
					return _Utils_eq(piece.side, side);
				},
				pieces));
	});
var $author$project$Xiangqi$initialPieces = function () {
	var soldiers = F2(
		function (side, rank) {
			return A2(
				$elm$core$List$map,
				function (file) {
					return _Utils_Tuple2(
						...
						A2($author$project$Xiangqi$Piece, side, $author$project$Xiangqi$Soldier));
				},
				_List_fromArray(
					[0, 2, 4, 6, 8]));
		});
			...
			return A3(
				...
				F2(
					function (file, kind) {
						return _Utils_Tuple2(
							_Utils_Tuple2(file, rank),
							A2($author$project$Xiangqi$Piece, side, kind));
					}),
				A2($elm$core$List$range, 0, 8),
				_List_fromArray(
					[$author$project$Xiangqi$Chariot, $author$project$Xiangqi$Horse, $author$project$Xiangqi$Elephant, $author$project$Xiangqi$Advisor, $author$project$Xiangqi$General, $author$project$Xiangqi$Advisor, $author$project$Xiangqi$Elephant, $author$project$Xiangqi$Horse, $author$project$Xiangqi$Chariot]));
		});
	return _Utils_ap(
		A2(backRank, $author$project$Xiangqi$Black, 0),
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2(
					_Utils_Tuple2(1, 2),
					A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Black, $author$project$Xiangqi$Cannon)),
					_Utils_Tuple2(
					_Utils_Tuple2(7, 2),
					A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Black, $author$project$Xiangqi$Cannon))
				]),
			_Utils_ap(
				A2(soldiers, $author$project$Xiangqi$Black, 3),
				_Utils_ap(
					A2(soldiers, $author$project$Xiangqi$Red, 6),
					_Utils_ap(
						_List_fromArray(
							[
								_Utils_Tuple2(
								_Utils_Tuple2(1, 7),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$Cannon)),
								_Utils_Tuple2(
								_Utils_Tuple2(7, 7),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$Cannon))
							]),
						A2(backRank, $author$project$Xiangqi$Red, 9))))));
}();
var $author$project$Xiangqi$isGameOver = F2(
	function (side, pieces) {
		return _Utils_eq(
			A2($author$project$Xiangqi$findGeneral, side, pieces),
			$elm$core$Maybe$Nothing) || $elm$core$List$isEmpty(
			A2($author$project$Xiangqi$generateLegalMoves, side, pieces));
	});
var $author$project$XiangqiTest$isOwnPieceAt = F3(
	function (position, pieces, side) {
		return A2(
			$elm$core$List$any,
			function (_v0) {
				var p = _v0.a;
				var piece = _v0.b;
				return _Utils_eq(p, position) && _Utils_eq(piece.side, side);
			},
			pieces);
	});
...
var $author$project$Xiangqi$perft = F3(
	function (depth, side, pieces) {
		if (depth <= 0) {
			return 1;
		} else {
			var moves = A2($author$project$Xiangqi$generateLegalMoves, side, pieces);
			return (depth === 1) ? $elm$core$List$length(moves) : $elm$core$List$sum(
				A2(
					$elm$core$List$map,
					function (_v0) {
						var from = _v0.a;
...
var $author$project$XiangqiTest$suite = A2(
		...
		[
				...
				[
					...
					function (_v0) {
						return A2(
							...
							44,
							A3($author$project$Xiangqi$perft, 1, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'depth 2 == 1920',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							1920,
							A3($author$project$Xiangqi$perft, 2, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'standard start position: neither side is in check',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_Tuple2(false, false),
							_Utils_Tuple2(
								A2($author$project$Xiangqi$inCheck, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces),
								A2($author$project$Xiangqi$inCheck, $author$project$Xiangqi$Black, $author$project$Xiangqi$initialPieces)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'flying general: open file between the two generals is mutual check',
					function (_v3) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
								_Utils_Tuple2(4, 0),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Black, $author$project$Xiangqi$General)),
								_Utils_Tuple2(
								_Utils_Tuple2(4, 9),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$General))
							]);
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_Tuple2(true, true),
							_Utils_Tuple2(
								A2($author$project$Xiangqi$inCheck, $author$project$Xiangqi$Red, pieces),
								A2($author$project$Xiangqi$inCheck, $author$project$Xiangqi$Black, pieces)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'flying general: a blocker on the file removes the check',
					function (_v4) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
								...
								_Utils_Tuple2(
								_Utils_Tuple2(4, 5),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$Soldier))
							]);
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_Tuple2(false, false),
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'a Red soldier attacks one rank forward (toward decreasing rank)',
					function (_v5) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
						...
						return A2(
							...
							A3(
								$author$project$Xiangqi$isSquareAttacked,
								_Utils_Tuple2(4, 4),
								$author$project$Xiangqi$Red,
								pieces));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'a Black soldier attacks one rank forward (toward increasing rank)',
					function (_v6) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
								...
								_Utils_Tuple2(
								_Utils_Tuple2(4, 4),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Black, $author$project$Xiangqi$Soldier))
							]);
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A3(
								$author$project$Xiangqi$isSquareAttacked,
								_Utils_Tuple2(4, 5),
								$author$project$Xiangqi$Black,
								pieces));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'a soldier that has crossed the river also attacks sideways',
					function (_v7) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
					...
					A2(
					$elm_explorations$test$Test$test,
					'a soldier that has NOT crossed the river does not attack sideways',
					function (_v8) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
			...
			A2(
			$elm_explorations$test$Test$describe,
			'checkmate / stalemate (loss either way in Xiangqi)',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'a lone general with both palace exits covered has lost',
					function (_v9) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
								...
								_Utils_Tuple2(
								_Utils_Tuple2(4, 9),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$Chariot)),
								_Utils_Tuple2(
								_Utils_Tuple2(8, 1),
								A2($author$project$Xiangqi$Piece, $author$project$Xiangqi$Red, $author$project$Xiangqi$Chariot))
							]);
						return A2(
							...
							_Utils_Tuple2(
								A2($author$project$Xiangqi$inCheck, $author$project$Xiangqi$Black, pieces),
								A2($author$project$Xiangqi$isGameOver, $author$project$Xiangqi$Black, pieces)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'a side with any legal move has not lost',
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Xiangqi$isGameOver, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'capturing a general ends the game immediately',
					function (_v11) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
			...
			A2(
			$elm_explorations$test$Test$describe,
			'basic move legality sanity checks',
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'start position has exactly 44 legal moves for Red',
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							44,
							$elm$core$List$length(
								A2($author$project$Xiangqi$generateLegalMoves, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'a general can capture the opposing general on an open file',
					function (_v13) {
						var pieces = _List_fromArray(
							[
								_Utils_Tuple2(
						...
						return A2(
							...
							A2(
								...
								_Utils_Tuple2(
									_Utils_Tuple2(4, 9),
									_Utils_Tuple2(4, 0)),
								A2($author$project$Xiangqi$generateLegalMoves, $author$project$Xiangqi$Red, pieces)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'a move is never legal onto a square occupied by your own piece',
					function (_v14) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2(
								...
								function (_v15) {
									...
									return A2(
										$elm$core$List$member,
										to,
										A2($elm$core$List$map, $elm$core$Tuple$first, $author$project$Xiangqi$initialPieces)) && A3($author$project$XiangqiTest$isOwnPieceAt, to, $author$project$Xiangqi$initialPieces, $author$project$Xiangqi$Red);
								},
								A2($author$project$Xiangqi$generateLegalMoves, $author$project$Xiangqi$Red, $author$project$Xiangqi$initialPieces)));
					})
				]))
